...
// The PromptRequestFunc type is an adapter to allow the use of ordinary
// function as PromptRequest mutator.
type PromptRequestFunc func(context.Context, *ent.PromptRequestMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PromptRequestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PromptRequestMutation); ok {
		return f(ctx, mv)
	}
