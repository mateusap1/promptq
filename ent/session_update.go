...
func (su *SessionUpdate) SetLastAccessed(t time.Time) *SessionUpdate {
	su.mutation.SetLastAccessed(t)
	return su
}

// SetNillableLastAccessed sets the "last_accessed" field if the given value is not nil.
func (su *SessionUpdate) SetNillableLastAccessed(t *time.Time) *SessionUpdate {
	if t != nil {
		su.SetLastAccessed(*t)
	}
	return su
}
...
func (su *SessionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.LastAccessed(); ok {
...
// SetLastAccessed sets the "last_accessed" field.
func (suo *SessionUpdateOne) SetLastAccessed(t time.Time) *SessionUpdateOne {
	suo.mutation.SetLastAccessed(t)
	return suo
}

// SetNillableLastAccessed sets the "last_accessed" field if the given value is not nil.
func (suo *SessionUpdateOne) SetNillableLastAccessed(t *time.Time) *SessionUpdateOne {
	if t != nil {
		suo.SetLastAccessed(*t)
	}
	return suo
}
...
func (suo *SessionUpdateOne) sqlSave(ctx context.Context) (_node *Session, err error) {
	...
	if value, ok := suo.mutation.LastAccessed(); ok {
		_spec.SetField(session.FieldLastAccessed, field.TypeTime, value)
	}
